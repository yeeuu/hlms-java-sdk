...
更新房间授权状态调用方法:
HttpClientData.getInstance().updateRoom(String room,String hotel_id,String secret,String phone,String start,String end); start和end 时间戳转String 例如:"1450197009","1458197009"
